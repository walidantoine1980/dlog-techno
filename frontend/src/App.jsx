...
const radarInnovations = [
  ...
  // NOUVELLES ENTREES: Assurance Qualité & Vision IA & Machine Vision & Deep Learning
  { id: 21, company: 'Keyence', title: 'LumiTrax & Profilomètres 3D IA', category: 'IA & Vision Industrielle', description: 'Technologie d\'éclairage multi-directionnel couplée à des caméras ultra-rapides et des algorithmes IA pour extraire les caractéristiques des défauts en ignorant les variations de surface.', link: 'https://www.keyence.com' },
  { id: 22, company: 'Cognex', title: 'In-Sight 3800 & VisionPro ViDi', category: 'IA & Vision Industrielle', description: 'Suite de Deep Learning industriel de pointe (ViDi) intégrée directement dans des caméras intelligentes 3D pour la classification complexe, la lecture OCR difficile et la détection d\'anomalies imprévisibles.', link: 'https://www.cognex.com' },
  { id: 23, company: 'Neurala', title: 'VIA (Vision Inspection Automation)', category: 'IA & Vision Industrielle', description: 'Logiciel de Vision IA (L-DNN - Lifelong Deep Neural Network) qui permet d\'entraîner des modèles d\'inspection qualité avec très peu d\'images défectueuses directement sur la ligne de production.', link: 'https://www.neurala.com' },
  { id: 24, company: 'SICK AG', title: 'SICK Nova & InspectorP6xx', category: 'Capteurs & Hardware', description: 'Capteurs de vision programmables intégrant des outils d\'Intelligence Artificielle Deep Learning (SICK Nova) pour l\'inspection qualité directement à la périphérie (Edge AI).', link: 'https://www.sick.com' },
  { id: 25, company: 'Zebra (Matrox Imaging)', title: 'Design Assistant X (Deep Learning)', category: 'IA & Vision Industrielle', description: 'Environnement de développement (Flowchart) pour la vision industrielle intégrant des outils de classification d\'images et de segmentation par apprentissage profond pour l\'Assurance Qualité.', link: 'https://www.zebra.com/us/en/products/machine-vision.html' }
];
